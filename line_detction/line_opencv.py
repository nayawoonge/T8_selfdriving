...
#카메라 객체 cap
#실시간 카메라 데이터 가져올 때는 cv2.VideoCapture(0)으로 함
cap = cv2.VideoCapture('C:/Users/LISA/Desktop/test.mp4')
#cap = cv2.VideoCapture('C:/Users/LISA/Desktop/cabc9045-5a50690f.mov')
ym_per_pix = 30 / 720
xm_per_pix = 3.7 / 720
...
while True:
    ...
    # 차선 읽어서 선으로 표시
    #result2 = detect_lane(img)
    #result1 = cv2.addWeighted(result, 1, result2, 0.4, 0)
