...
def roi(image):
  # 좌상, 좌하, 우하, 우상
    source = np.array([[300,500], [50,550],[800,550], [550,500]])

    cv2.polylines(image, [source], 1, (255,0,0))
    ...
    cv2.fillPoly(mask, np.int32([source]), ignore_mask_color)
...
while True:
    ...
    # 조감도 wrapped img
    wrapped_img, minverse = wrapping(blur)
